...
function orchid_store_customize_preview_js() {
	wp_enqueue_script( 'orchid-store-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}

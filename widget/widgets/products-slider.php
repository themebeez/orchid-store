<?php
/**
 * Display Products In Carousel Widget Class
 *
 * @package Orchid_Store
 */

if( ! class_exists( 'Orchid_Store_Products_Carousel_Widget' ) ) {

    class Orchid_Store_Products_Carousel_Widget extends WP_Widget {
     
        function __construct() { 

            parent::__construct(
                'orchid-store-products-carousel-widget',
                esc_html__( 'OS: Product Carousel', 'orchid-store' ),
                array(
                    'classname'     => '',
                    'description'   => esc_html__( 'Displays products in carousel.', 'orchid-store' ), 
                )
            );     
        }

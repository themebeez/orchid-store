...
- Tested:  WooCommerce version 8.9.3.
...
- Updated: Checked for instance of `WC_Product` in functions hooked on custom actions.
- Tested:  WooCommerce version 8.6.1.
- Tested:  WordPress version 6.4.3.
...
- Fix: WC products mobile column issue.
...
- Fix: Action button style in product widgets & catalog pages.
- Tweak: Addonify comparison modal table style.

== 1.3.8 - 7 August, 2022 ==

- Added: Addonify – Compare Products For WooCommerce recommended.
...
- Updated: Everest Backup plugin recommendation notice added.
